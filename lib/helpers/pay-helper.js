...
module.exports = {
  ...
  pay(paymentStream, sourcePublic, signersKeypairs, payers, options) {
    ...
    const validWithoutMemo = paymentStream
      ...
      .map((d) => stellarPay(sourcePublic, d, signersKeypairs, payers, stellarHelper))
      .parallel(options.batchSize);
...
function stellarPay(senderAccount, payments, signers, payerQueue, stellarHelper) {
